const COLORS: Record<string, string> = {
  ...
  Increasing: "bg-red-500/15 text-red-400 border-red-500/30",
  Decreasing: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30",
...
export function StatusBadge({ label, colorKey }: { label: string; colorKey?: string }) {
  const cls = COLORS[colorKey ?? label] ?? "bg-slate-500/15 text-slate-300 border-slate-500/30";
  return (
